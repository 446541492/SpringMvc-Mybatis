...
public class DateUtil {  
    ...
    public static String getFormatDate(Date date,DateStyle format) {
		return new SimpleDateFormat(format.toString()).format(date);
	}
    /** 
     * 获取日期。默认yyyy-MM-dd HH_MM_SS格式。
     * @param date 日期 
     * @return 日期 
     */  
	public static String getDateTime(Date date) {
		return getFormatDate(date,DateStyle.YYYY_MM_DD_HH_MM_SS);
	}
    /** 
