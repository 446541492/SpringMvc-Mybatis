...
public class Blowfish {
    ...
    public static String INIT_KEY = "com.job36";
    
	public static void main(String[] args) throws Exception {
		Blowfish encoder=new Blowfish(INIT_KEY);  //传入密钥
		String oStr="1";
		String encodedStr=encoder.encryptString(oStr); 
		System.out.println("---"+encodedStr);
		
		String ss = encoder.decryptString("9355ee46c5e9392db615f80dcaac4a3be04b1f4875410ca5");
